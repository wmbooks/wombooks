document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderAuthorsList() {
        ...
        sortedAuthors.forEach(author => {
            ...
            authorHeader.innerHTML = `
                <span>${author}</span>
                <span class="round-arrow author-arrow">➔</span>
            `;

            const seriesList = document.createElement('div');
            seriesList.className = 'author-series-list';
            ...
            sortedSeries.forEach(series => {
                ...
                seriesItem.appendChild(seriesGrid);
                seriesList.appendChild(seriesItem);
            });

            authorItem.appendChild(authorHeader);
            authorItem.appendChild(seriesList);
    ...
    window.toggleAuthor = function(headerElement) {
        ...
        if (authorItem.classList.contains('open')) {
            authorItem.classList.remove('open');
        } else {
            authorItem.classList.add('open');
        }
    };
    ...
    window.toggleSeries = function(headerElement) {
        ...
        if (seriesItem.classList.contains('open')) {
            seriesItem.classList.remove('open');
        } else {
            seriesItem.classList.add('open');
        }
    };
